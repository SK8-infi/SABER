...
from project.visualization.similarity import plot_retrieval_grid
from project.visualization.attention import visualize_attention_map
...
def main() -> None:
    ...
    if not os.path.exists(config.retrieval.index_path):
        raise FileNotFoundError(
            ...
            f"Please run evaluation/indexing first: python project/evaluate.py"
        )
