...
def main():
    venv_python = os.path.abspath("./rejepa/.venv/Scripts/python.exe")
    ...
    config_path = "rejepa/configs/config.yaml"
    ...
    try:
        ...
        run_command([
            venv_python, "rejepa/evaluate.py",
