...
from Saber_dofa.utils.checkpoint import load_checkpoint
...
from Saber_dofa.retrieval.faiss_index import FAISSIndex
from Saber_dofa.retrieval.retriever import Retriever
from Saber_dofa.visualization.similarity import plot_retrieval_grid
from Saber_dofa.visualization.attention import visualize_attention_map
...
def main() -> None:
    ...
    if not os.path.exists(config.retrieval.index_path):
        raise FileNotFoundError(
            ...
            f"Please run evaluation/indexing first: python Saber_dofa/evaluate.py"
        )
