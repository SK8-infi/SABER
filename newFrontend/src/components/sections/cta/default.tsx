  ...
  return (
    <Section className={cn("group relative overflow-hidden", className)}>
      <div className="max-w-container relative z-10 mx-auto flex flex-col items-center gap-6 text-center sm:gap-8">
        <span className="text-xs font-bold uppercase tracking-widest text-[#FBBA72]">ISRO BAH 2026 · Problem Statement 11</span>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <LinkButton variant="default" size="lg" href="/dashboard/format/query">Launch Demo</LinkButton>
          <LinkButton variant="glow" size="lg" href="https://github.com/SK8-infi/SABER">View on GitHub</LinkButton>
        </div>
      </div>
