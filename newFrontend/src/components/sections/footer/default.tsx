        ...
        <Footer>
          <FooterContent>
            ...
            <FooterColumn>
              ...
              <a href="https://github.com/SK8-infi/SABER" target="_blank" rel="noopener noreferrer"
                className="text-muted-foreground text-sm hover:text-foreground transition-colors">GitHub</a>
              <a href="https://www.isro.gov.in" target="_blank" rel="noopener noreferrer"
                className="text-muted-foreground text-sm hover:text-foreground transition-colors">ISRO</a>
              <a href="https://sentinel.esa.int" target="_blank" rel="noopener noreferrer"
                className="text-muted-foreground text-sm hover:text-foreground transition-colors">ESA Sentinel</a>
            </FooterColumn>
          </FooterContent>

          <FooterBottom>
            <div className="text-sm text-muted-foreground">
              © 2026 Team Sentinel8 · SABER · ISRO BAH Grand Finale
            </div>
            <div className="flex items-center gap-4">
              <span className="text-xs text-muted-foreground">
                Copernicus Sentinel data © ESA 2023–2026
              </span>
              <ModeToggle />
            </div>
          </FooterBottom>
