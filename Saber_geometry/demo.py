...
from Saber_geometry.retrieval.retriever import Retriever
from Saber_geometry.visualization.similarity import plot_retrieval_grid
from Saber_geometry.visualization.attention import visualize_attention_map
...
def main() -> None:
    ...
    if not os.path.exists(config.retrieval.index_path):
        raise FileNotFoundError(
            ...
            f"Please run evaluation/indexing first: python Saber_geometry/evaluate.py"
        )
