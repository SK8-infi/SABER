...
def main():
    venv_python = os.path.abspath("./Saber_geometry/.venv/Scripts/python.exe")
    ...
    config_path = "Saber_geometry/configs/config.yaml"
    ...
    try:
        # 1. Train SAR
        run_command([
            venv_python, "Saber_geometry/train.py",
            "--epochs", "5",
            "--synthetic", "false",
            "--batch_size", "32",
            "--modality", "s1"
        ...
        run_command([
            venv_python, "Saber_geometry/evaluate.py",
