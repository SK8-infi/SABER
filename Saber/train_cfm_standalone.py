...
def train_cfm_standalone(
    ...
    train_dataset = BEN14KDataset(data_dir=data_dir, split="train", use_synthetic=False)
    test_dataset = BEN14KDataset(data_dir=data_dir, split="test", use_synthetic=False)
